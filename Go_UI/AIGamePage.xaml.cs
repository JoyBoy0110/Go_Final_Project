...
namespace Go_UI
{
    ...
    public partial class AIGamePage : Window
    {
        ...
        private IAI ai; // the finite state machine of the game
        ...
        public AIGamePage(double komi, Player player, int size)
        {
            InitializeComponent();
            AiColor = player;
        ...
        private void DrawCurrentBoard(Go_Board board)
        {
            ...
            {
                PieceImages[cordinates.Item1, cordinates.Item2].Source =
                    Images.GetStoneImage(board.board_dict[cordinates]);
            }
